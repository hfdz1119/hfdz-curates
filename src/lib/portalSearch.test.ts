...
const category: PortalCategory = { id: "tools", name: "效率工具", order: 0, hidden: false, palette: "aurora", visibility: "public" };
const site: ManagedPortalSite = { id: "one", name: "图片管理", description: "上传图片", url: "https://img.example.com/", hostname: "img.example.com", category: category.name, categoryId: category.id, emphasis: "standard", access: "public", visibility: "public", pinned: false, order: 0 };
